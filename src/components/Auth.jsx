        ...
        <div className="fixed w-full px-4 py-24 z-50">
          <div className="max-w-[450px] h-[600px] z-50 bg-black/75 mx-auto text-white">
            <div className="flex flex-col justify-center items-center">
              <h3 className="text-white text-4xl pt-24 text-center font-bold">
              ...
              <form className=" justify-center items-center text-center flex flex-col py-4">
                ...
                <button
                  onClick={authFunc}
                  type="button"
                  className="z-50 cursor-pointer hover:bg-red-700 transition-all bg-red-600 py-3 my-6 w-[314px] rounded font-bold"
                >
                  {signUp ? "Kayıt Ol" : "Oturum Aç"}
                </button>
              </form>
              <div className="flex gap-2 text-white items-center justify-center text-center">
                ...
                >
                  {signUp ? "Zaten hesabın var mı?" : "Şimdi Kayıt ol"}
                </p>
              </div>
            </div>
          </div>
